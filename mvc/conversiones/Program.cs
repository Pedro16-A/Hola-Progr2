...
namespace Currency_Converter
{
    ...
    {
        private const double usd = 4128814.00 ;
        private const double cop = 19244.00;
        private const double pen = 94818.00 ;
    ...
    class Converter_controler
    {
        static void Main(string[] args)
        {
            ...
            {
                viewObj.viewBasic();
                Console.WriteLine("Que conversión desea hacer?:\n");
                typeX = Convert.ToByte(Console.ReadLine());
                Console.WriteLine("");
                modelObj.setType(typeX);

                Console.WriteLine("¿Cuanto dinero desea cambiar?\n");
